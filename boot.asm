...
; floppy for KERNEL.BIN (the alOS kernel), loads it and executes it.
...
VolumeLabel		db "ALOS     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; alOS kernel filename
