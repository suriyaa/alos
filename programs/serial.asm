...
;
; Connect the serial cable to your alOS machine and Linux machine.
; Start alOS and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the alOS machine, you will see a
...
erase_sub:
	...
	start_msg	db 'alOS minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting alOS minicom; press a key to return to alOS', 13, 10, 0
